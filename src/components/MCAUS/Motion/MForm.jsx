        ...
        <>
            <div class="bg-white h-[90vh] relative   border-t-[3vh] border-[#F0F0F0] border-t-[#181818]   rounded-3xl w-2/5 p-4">
                ...
                <div class="mt-28 mx-4">
                    ...
                    <input type="text" id="base-input" placeholder='Enter Topic Name' class="bg-white border border-[#999999] text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mt-10 mx-4">
                        <label for="base-input" class="block mb-2 text-md font-bold text-[#555555] dark:text-white">Total Time</label>
                        <input type="number" id="base-input" placeholder='Enter Minutes' class="bg-white border border-[#999999] text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                    <div class="mt-10 mx-4">
