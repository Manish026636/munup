        ...
        <div>
            <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white ">
                <div className='flex justify-center items-center'>
                    <img class="w-auto h-10" src="MunLogo.png" alt="" />
                </div>
                ...
                <div class="flex flex-col justify-between flex-1 mt-6">
                    ...
                    <Link to="/"><button class="flex items-center border border-[#F0F0F0] px-3 mt-2 py-2 w-full text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                        ...
                        <Link to="/RCDashboard"><button class="flex items-center mt-2 border border-[#F0F0F0] w-full px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        ...
                        <Link to="/GSLDashboard"><button class="flex items-center mt-2 border border-[#F0F0F0] w-full px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        ...
                        <Link to="/MRegister"><button class="flex items-center mt-2 border border-[#F0F0F0] w-full px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
