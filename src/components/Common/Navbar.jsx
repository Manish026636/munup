        ...
        <nav className="flex items-center justify-between h-16 lg:h-20">
          <div className="flex-shrink-0">
            <a href="#" title="" className="flex">
              <img
                className="w-auto lg:mt-0 md:mt-6 h-8 lg:h-10"
                src="Munlogo.png"
                alt=""
              />
            </a>
          ...
          <a
            ...
            title=""
            className="items-center justify-center hidden px-4 py-2 ml-10 text-base font-semibold text-white transition-all duration-200 bg-gray-900 border border-transparent rounded-md lg:inline-flex hover:bg-gray-800 focus:bg-blue-700"
            role="button"
          >
            Login
          </a>
