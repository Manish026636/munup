            ...
            <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white ">
                ...
                <div class="flex flex-col justify-between flex-1 mt-6">
                    <nav class="flex-1 -mx-3 space-y-3 ">
                        ...
                        <button class="flex items-center border border-[#F0F0F0] px-3 py-2 w-full text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
