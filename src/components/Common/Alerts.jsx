...
const Alerts = () => {
  return (
    ...
    <div class="flex items-center justify-center w-12 bg-[#10b981]">
...
<div class="flex mt-20  w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
...
<div class="flex mt-20 w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <div class="px-4 py-2 -mx-3">
        <div class="mx-3">
            <span class="font-semibold text-yellow-600 dark:text-yellow-500">Warning</span>
